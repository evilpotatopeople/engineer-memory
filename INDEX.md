...
|------|------|-------|------|
| 2026-09-07 | investigation | dtc-dashboard 回購結構圖顯示已下架品（晶球糧/爽肉泥）— 不是分類錯、是區塊固定算全期訂單 + product_dim.status 全「在售」dead field | investigations/2026-09-07_回購結構圖顯示下架品.md |
